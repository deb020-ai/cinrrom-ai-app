...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-[#070709]/95 backdrop-blur-2xl border-b border-white/[0.06] z-50 flex items-center justify-between px-4">
      ...
      {/* SIDEBAR DRAWER (Desktop fixed + Mobile slide-over) */}
      <aside
        className={`w-64 h-screen border-r border-white/[0.06] bg-[#070709]/95 backdrop-blur-2xl flex flex-col fixed left-0 top-0 z-50 transition-transform duration-300 ${
