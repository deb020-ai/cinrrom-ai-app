...
###############################################################
Before generating any frame, perform an exhaustive visual analysis of {PRODUCT_IMAGE}.
...
###############################################################
Shot on ARRI Alexa 65 / IMAX Film.
Prime cinema lenses (Panavision Primo / Leica Leitz Cine).
Physically correct lighting.
Raytraced reflections.
Photorealistic refractions.
...
FINAL DIRECTIVE
###############################################################
Deliver a ultra-photorealistic, high-converting luxury commercial worthy of Cartier, Bvlgari, Tiffany & Co. or Van Cleef & Arpels.`,

  // 2. VIDEO: LUXURY FASHION CAMPAIGN
  video_model_campaign: `###############################################################
...
MODEL SELECTION
###############################################################
Featured Model Profile:
Gender: {GENDER}
Age: {AGE_RANGE}
Country of Origin: {COUNTRY_ORIGIN}
Ethnicity: {ETHNICITY}
The model must naturally embody the specified origin and ethnicity with striking, authentic high-fashion features suitable for a global Vogue luxury jewelry editorial campaign.
###############################################################
PRODUCTION DESIGN
###############################################################
Every environment must feel handcrafted by world-class production designers rather than AI-generated.
...
CINEMATOGRAPHY
###############################################################
ARRI Alexa 65 cinema optics, 85mm f/1.2 portrait lens, soft key directional lighting, shallow depth of field. High-fashion commercial color grading.`,

  // 3. VIDEO: OUTDOOR CAMPAIGN
  video_outdoor_campaign: `###############################################################
...
The model must naturally embody the specified origin and ethnicity with striking, authentic high-fashion features suitable for a global Vogue luxury jewelry editorial campaign.
###############################################################
OUTDOOR LOCATION & ATMOSPHERE
###############################################################
Set in a breathtaking luxury outdoor environment (Amalfi Coast cliffs, French Riviera, Alpine mountain peaks, Mediterranean marble terrace). Golden hour natural lighting, sun flares, sea breeze motion blur.
###############################################################
PRODUCTION DESIGN
###############################################################
Every environment must feel handcrafted by world-class production designers rather than AI-generated.
...
Every frame should resemble a meticulously art-directed luxury editorial photograph captured inside a bespoke multi-million-dollar production set.`,
  ...
  // 4. VIDEO: ANIMAL CAMPAIGN
  video_animal_campaign: `###############################################################
ANIMAL CAMPAIGN ENGINE
###############################################################
Create a world-class luxury jewelry commercial pairing fine jewelry with a majestic companion wildlife animal.
###############################################################
PRODUCT ANALYSIS & LOCK (HIGHEST PRIORITY)
###############################################################
Before generating any frame, perform an exhaustive visual analysis of {PRODUCT_IMAGE}.
...
###############################################################
Featured Companion Animal: {COMPANION_ANIMAL}
Featured Model Profile:
Gender: {GENDER}
Age: {AGE_RANGE}
Country of Origin: {COUNTRY_ORIGIN}
Ethnicity: {ETHNICITY}
The companion animal must complement the majesty and power of the jewelry without overpowering product visibility.
###############################################################
PRODUCTION DESIGN
###############################################################
Every environment must feel handcrafted by world-class production designers rather than AI-generated.
...
###############################################################
Before generating any frame, perform an exhaustive visual analysis of {PRODUCT_IMAGE}.
Analyze and permanently lock every manufacturing detail.
The uploaded jewelry is permanently locked.
###############################################################
PRODUCTION DESIGN
###############################################################
Every environment must feel handcrafted by world-class production designers rather than AI-generated.
...
Every frame should resemble a meticulously art-directed luxury editorial photograph captured inside a bespoke multi-million-dollar production set.`,
  ...
  // 6. IMAGE: LUXURIOUS JEWELRY PRODUCT HERO
  image_product_hero: `###############################################################
...
Create a timeless luxury product campaign where the jewelry commands immediate attention and every surrounding element quietly reinforces its beauty. The production should feel custom-built with extraordinary craftsmanship and an unlimited budget, yet remain visually restrained, elegant and believable. The image must never reveal itself as AI-generated through excessive detail, unnecessary complexity or artificial styling. It should resemble a real photograph produced by one of the world's finest luxury advertising teams, where the viewer remembers the jewelry first and the production second.`,
  ...
  // 7. IMAGE: LUXURY JEWELRY MODEL CAMPAIGN
  image_model_campaign: `###############################################################
...
Create a timeless luxury jewelry fashion campaign where the model embodies elegance without overshadowing the product. Every artistic decision—including casting, wardrobe, pose, expression, lighting, set design and composition—must strengthen the emotional value of the jewelry. The viewer should first notice the jewelry, then the model, and finally the sophistication of the production. The campaign should feel indistinguishable from an authentic luxury editorial produced by one of the world's leading fashion houses, combining impeccable realism, refined restraint and extraordinary craftsmanship while remaining immediately ready for luxury Meta advertising, premium social campaigns and world-class brand marketing.`,
  ...
  // 8. IMAGE: OUTDOOR EPIC ENVIRONMENT CAMPAIGN
  image_fantasy_world: `###############################################################
...
Create an unforgettable international luxury jewelry campaign where an iconic real-world environment amplifies the emotional power of the jewelry without ever competing with it. The jewelry remains the commercial hero, the model creates aspiration, and the environment creates wonder. Every artistic decision—from location, wardrobe, pose, lighting, composition and production design—should increase the perceived value of the jewelry. The final image must be indistinguishable from a real multi-million-dollar luxury campaign produced by the world's leading advertising agency, immediately ready for Meta Ads, premium social media, editorial magazines and global luxury brand marketing.`,
  ...
  // 9. IMAGE: LUXURY JEWELRY ANIMAL CAMPAIGN
  image_animal_campaign: `###############################################################
