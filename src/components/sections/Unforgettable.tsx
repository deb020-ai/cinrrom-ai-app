    ...
    <section ref={containerRef} className="relative h-[150vh] w-full bg-black overflow-hidden">
      ...
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ scale }} className="absolute inset-0 w-full h-full opacity-60">
          <LazyVideo 
            src="https://pub-e4b98781681b4d27a8e28caaf73b8ca4.r2.dev/CINROOM%20WEBSITE%20ASSESTS/porfolio/videos/compress/Emerald%20Precision%20Reduce%20Size%202.mp4"
